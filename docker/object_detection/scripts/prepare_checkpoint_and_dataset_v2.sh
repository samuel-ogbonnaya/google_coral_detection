...
mv "${LEARN_DIR}/train_labels.csv" "${DATASET_DIR}"
mv "${LEARN_DIR}/test_labels.csv" "${DATASET_DIR}"
...
python generate_tfrecord.py --csv_input="${DATASET_DIR}/train_labels.csv" --image_dir="${DATASET_DIR}/train" --output_path="${DATASET_DIR}/train.record"

echo "CONVERTING test dataset to TF Record..."
python generate_tfrecord.py --csv_input="${DATASET_DIR}/test_labels.csv" --image_dir="${DATASET_DIR}/test" --output_path="${DATASET_DIR}/test.record"
