...
def iterate_dir(source, dest, ratio, copy_xml, delete):
...
def main():
    ...
    parser.add_argument(
        '-d', '--delete',
        help='Set this flag if you want to delete the originl images.',
        default= "true"
    )
    ...
    iterate_dir(args.imageDir, args.outputDir, args.ratio, args.xml, args.delete)
